...
> ⚠️ **2026-08-11 — Важно:** COS объявил о сворачивании OSF Projects. Пререгистрации (OSF Registries) **остаются**; рабочие проекты станут **read-only 19.02.2027** (новые нельзя создавать с 16.11.2026).
> Для HAP: регистрация `osf.io/dqy38` остаётся; проект `osf.io/mgzt5` станет read-only — **файлов в проекте нет, экспорт не нужен** (проверено 2026-08-11).
