...
3. **Sample size calc (power analysis)** — ✗  
   Есть расчёт для M1 (N=286) и для CEDAR (n=30/group), но **расчёт для contamination — N = TBD**. Формулы приведены, но подстановки неполные. Не выполнено в полном объёме.
