...
2. **`UMBRELLA/CONCEPT.md` §5 (Falsifiability)**  
   *Явно сформулировать фальсификационный порог для **χ_Ze как первичной метрики** – какую partial r² или AUC ожидаете и при каком N отклоняется гипотеза (сейчас фальсификация только для MCAOA).*
