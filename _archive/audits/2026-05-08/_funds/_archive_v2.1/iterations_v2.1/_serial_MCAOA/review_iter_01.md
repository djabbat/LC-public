...
1. **`MCAOA/PARAMETERS.md` — Matrix Γ, cell (EpiDrift, MitoROS)**  
...
2. **`MCAOA/EVIDENCE.md` — Section “Internal data / LOO-CV”**  
...
3. **`MCAOA/EVIDENCE.md` — “FLAGGED – needs replacement” for NAD⁺/sirtuin/epigenetic link**  
...
4. **`MCAOA/CONCEPT.md` — Coupling matrix Γ section**  
...
5. **`MCAOA/PARAMETERS.md` — Table of tissue weights (w_i)**  
...
MCAOA is the theoretical mother-project of the LC aging-science stack. It formalises organismal aging as the weighted sum of multiple parallel damage