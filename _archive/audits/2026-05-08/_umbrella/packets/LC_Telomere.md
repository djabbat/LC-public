...
`Telomere/CONCEPT.md` называет себя «Counter #2», но `CEDAR/CONCEPT.md` тоже использует «Counter #2» в parent-link block. Это P0 finding из audit 2026-05-07; ждём решение user'а до переименования.
...
*   **[ROADMAP.md](./ROADMAP.md)** — План будущих работ: приоритетные задачи, зависимость от других подпроектов (например, CEDAR для валидации), этапы интеграции.
