...
1. **NOT to confuse with `djabbat/DrJaba` (drjaba.com)** — that's the
   ...
   itself.
2. **Commercial flow** — Tqemaladze personal / drjaba.com Stripe. NOT GLA
...
Lead-generation / sales / media tracks for Tqemaladze, all under one folder.
...
```md
# Marketing — umbrella for Tqemaladze's lead-generation tracks
...
Все каналы лидогенерации/продаж/медиа Tqemaladze под одной крышей.
...
- **First title:** Ze Theory (Tqemaladze's monograph; final version v10)
...
All under Tqemaladze personal entity (drjaba.com / Longevity Clinic Inc. / Stripe). NOT under GLA or Sulkalmakhi NGO accounting — these are commercial revenue streams, separate from charity/grant flows.
...
## Аксиома 2 — Tqemaladze personal entity, не NGO
...
- **Все commercial revenue → Tqemaladze personal entity** (drjaba.com / Longevity Clinic Inc. / Stripe).
...
- **Tqemaladze personal entity** — все commercial revenue, НЕ NGO accounting
