# AUDIT PACKET — LC_root

Path: `/home/oem/Desktop/LC`  Date: 2026-05-08

## Size & file counts
```
8,3G	/home/oem/Desktop/LC
```
**Extensions:** .md=594, .rs=476, .py=361, .toml=240, .mat=211, .ex=183, .json=181, .exs=102, .docx=87, .sh=44, .png=39, .txt=39, (noext)=36, .service=31, .pdf=28
## Tree (depth=2, max 200 entries)
```
.
./Proteostasis
./Proteostasis/frontend
./Proteostasis/PARAMETERS.md
./Proteostasis/AGENTS.md
./Proteostasis/EVIDENCE.md
./Proteostasis/crates
./Proteostasis/DESIGN.md
./Proteostasis/README.md
./Proteostasis/backend
./Proteostasis/PARAMETERS_calibrated.json
./Proteostasis/scripts
./Proteostasis/CLAUDE.md
./Proteostasis/THEORY.md
./Proteostasis/OPEN_PROBLEMS.md
./Proteostasis/docs
./Proteostasis/CONCEPT.md
./MitoROS
./MitoROS/frontend
./MitoROS/PARAMETERS.md
./MitoROS/AGENTS.md
./MitoROS/EVIDENCE.md
./MitoROS/crates
./MitoROS/DESIGN.md
./MitoROS/README.md
./MitoROS/backend
./MitoROS/PARAMETERS_calibrated.json
./MitoROS/scripts
./MitoROS/CLAUDE.md
./MitoROS/THEORY.md
./MitoROS/OPEN_PROBLEMS.md
./MitoROS/docs
./MitoROS/CONCEPT.md
./deploy
./deploy/web-shared
...
./deploy/scripts
./deploy/systemd
./deploy/docker-compose-all.OLD-pre-v5.6.yml
./STATE.md
./PARAMETERS.md
./server
./server/migrations
...
./AIM/rust-core
./AIM/tests
./AIM/claude_memory_analysis.txt
./AIM/STACK.md
./AIM/db.py
./AIM/STRATEGY.md
./AIM/tools
./AIM/medical_system.py
./AIM/reports
./AIM/aim.db.backup-20260502-154658
./AIM/AI
./AIM/README.md
./AIM/logs
./AIM/aim.db-shm
...
./AIM/scripts
./AIM/USER
./AIM/claude_memory_analysis.json
./AIM/web
./AIM/fonts
./AIM/release
./AIM/CLAUDE.md
...
./EVIDENCE.md
./AutomatedMicroscopy
./AutomatedMicroscopy/ROADMAP.md
./AutomatedMicroscopy/PARAMETERS.md
./AutomatedMicroscopy/AGENTS.md
./AutomatedMicroscopy/EVIDENCE.md
./AutomatedMicroscopy/DESIGN.md
./AutomatedMicroscopy/README.md
./AutomatedMicroscopy/CLAUDE.md
./AutomatedMicroscopy/THEORY.md
./AutomatedMicroscopy/OPEN_PROBLEMS.md
./AutomatedMicroscopy/docs
./AutomatedMicroscopy/CONCEPT.md
...
./MCAOA/CLAUDE.md
./MCAOA/THEORY.md
./MCAOA/OPEN_PROBLEMS.md
./MCAOA/docs
./MCAOA/CONCEPT.md
./MCAOA/LICENSE
./CytogeneticTree
./CytogeneticTree/ImageAnalysis
./CytogeneticTree/PARAMETERS.md
./CytogeneticTree/CellPose_Segmentation
./CytogeneticTree/AICoordinator
./CytogeneticTree/LiveCellMicroscopy
./CytogeneticTree/GenealogyReconstruction
./CytogeneticTree/LentiviralTools
./CytogeneticTree/README.md
./CytogeneticTree/StatisticalAnalysis
./CytogeneticTree/UPGRADE.md
./CytogeneticTree/RITE_Centriole
./CytogeneticTree/DifferentiationAnnotation
./CytogeneticTree/TODO.md
./CytogeneticTree/MEMORY.md
./CytogeneticTree/CLAUDE.md
./CytogeneticTree/LINKS.md
./CytogeneticTree/LaserAblation_405
./CytogeneticTree/MicroscopeController
./CytogeneticTree/CONCEPT.md
```
## Detected stack: **Rust, Phoenix/Elixir, Node/JS, Python, PHP**
## Core files

### `CLAUDE.md` (8246 chars)
```md
...
```
### `Proteostasis/CLAUDE.md` (1600 chars)
```md
...
**Three-level framework** (per Tqemaladze J. (2026) "Patient as a Project", *Longevity Horizon* 2(5), [DOI 10.65649/qqwva850](https://doi.org/10.65649/qqwva850)):
...
```
### `Proteostasis/README.md` (3886 chars)
```md
...
```
### `Proteostasis/CONCEPT.md` (20392 chars)
```md
...
```
### `MitoROS/CONCEPT.md` (29234 chars)
```md
...
**Источник:** Tqemaladze J. (2026) *Patient as a Project*, *Longevity
...
- Blumenthal D., Lee J. (2024) *Four-zone framework for human-AI clinical
  collaboration.* JAMA.
- Tqemaladze J. (2026) *Patient as a Project: Three-level framework for
...
**Status:** Cross-subproject consistency map · 2026-04-28 (CONCEPT v5.6)
**Authority:** Used by session-startup integrity check + grant alignment.

---

## §1. Subprojects ↔ EIC grant role
...
| **Activated** | Clinical pilot | WP5 (clinical validation site) | Шашвиашвили готов |
| HAP | — | ❌ NOT in grant (TOXIC, halted) | failed PMID audit 2026-04-21 |
| Ontogenesis | — | ❌ NOT in grant (TOXIC, halted) | failed PMID audit 2026-04-21 |
| Telomere/MitoROS/EpigeneticDrift/Proteostasis | counter modules | mention only as "future MCAOA counters" | concept-stage |
| CytogeneticTree | tooling demo | future work | demo-stage |
| AutomatedMicroscopy/E0 | hardware demo | future dissemination | Phase 1 ordering 2026-05-03 |

## §2. Quantity propagation (cross-subproject)

```
   ┌─────────────────────────────────────────────────────────┐
   │  Ze theory: I(Z), τ_Ze, v*, χ_Ze formal foundation     │
   └─────────────────────────┬───────────────────────────────┘
                             ↓
   ┌─────────────────────────────────────────────────────────┐
   │  BioSense: v* = 0.45631 (validated swept-v*),           │
   │  χ_Ze composite over EEG/HRV/resp/sleep                 │
   └─────────────────────────┬───────────────────────────────┘
                             ↓
   ┌─────────────────────────┴───────────────────────────────┐
   ...
   └─────────────────────────┬───────────────────────────────┘
                             ↓
   ┌─────────────────────────────────────────────────────────┐
   │ FCLC: federated training of cohort models on χ_Ze       │
   │ trajectories with DP (ε ≤ 1.0/round, semi-honest)       │
   └─────────────────────────────────────────────────────────┘
```

## §3. Cross-subproject API matrix

Каждая стрелка — HTTP API call (loopback only by default):

| From | To | Endpoint | Purpose |
|------|----|----|---------|
| Social server (`server/`) | BioSense :4101 | `POST /api/chi_ze` | Display χ_Ze in user dashboard |
| Social server | BioSense :4101 | `POST /api/exacerbation` | 30-day risk widget |
| Social server | Ze :4001 | `POST /api/chsh` (read-only) | Theoretical visualisation |
| Social server | FCLC :4002 | `GET /api/metrics` | Federated round status |
| Social web (`web/`) | Social server :8080 | various | UI ↔ API |
| Social realtime (`realtime/`) | Social server :8080 | WS proxy | Live feed |
| BioSense backend | (no upstream) | — | Pure compute |
| Ze backend | (no upstream) | — | Pure compute |
| FCLC backend | (no upstream) | — | Pure compute |

**No subproject calls another subproject directly** — все science backends loopback-only, social server orchestrates.

## §4. Cross-doc invariants (must hold)

| ID | Invariant |
|----|-----------|
| **U1** | Cross-cutting status (hypothesis-stage, NOT peer-reviewed, NULL retraction, threat model) — единое описание в umbrella `CONCEPT.md`; не дублируется в subproject CONCEPTs (только ссылка). |
| **U2** | Каждый subproject имеет local `CONCEPT.md` для internal math; в случае conflict — umbrella > subproject. |
| **U3** | `v*` value (`0.45631` Python; `−0.087` Article) единый по всем subproject + umbrella PARAMETERS. |
| **U4** | M4 falsifiability threshold (N≥2000, α=0.001, partial r²<0.05) единый везде. |
| **U5** | FCLC threat model (semi-honest server only; not active) — единое определение в umbrella + FCLC. Не противоречить в Ze·Guide промптах или web disclosures. |
| **U6** | TOXIC list (HAP, Ontogenesis) единый везде. Если в коде есть импорт — это ошибка. |
| **U7** | Social layer (server/web/realtime) НЕ содержит научных формул — только delegation в subprojects. |

## §5. Hubs

| Hub | Why |
|-----|-----|
| `LC/CONCEPT.md` (this regenerate) | Single source of cross-cutting status; bug here propagates to all subprojects + grant docs. |
| `BioSense/biosense-simulator` | Только реализация χ_Ze; bug breaks everything downstream (web display, social server, FCLC training data). |
| `FCLC/fclc-core/src/dp/` | DP composition; bug here breaks privacy guarantee. |

## §6. Dead artifacts (cleanup list)

| Artifact | Status | Action |
|----------|--------|--------|
| `_archive/v_pre_2026-04-28/CONCEPT.md` etc. | Archived old core .md | Keep for diff/history |
| Old `~/Desktop/LC/CONCEPT.md` (pre-v5) | Replaced today | Already moved to archive |
| `HAP/`, `Ontogenesis/` directories | TOXIC | Don't import; flag in any new doc that touches them |
| Subproject `CONCEPT.md` text contradicting umbrella v5.6 | Stale | Pull cross-cutting status from umbrella; update local CONCEPT to match (Phase 2) |

## §7. Refresh cycle

When article (`~/Desktop/LC.md`) changes:
...
When subproject internal math changes — subproject `CONCEPT.md` updates; umbrella affected only if cross-cutting (status, threat, falsifiability).

```
### `AIM/MAP.md` (7577 chars)
```md
# MAP.md — AIM v7.0
...
```
### `CytogeneticTree/MAP.md` (3460 chars)
```md
# MAP — CytogeneticTree
...
```
### `Proteostasis/PARAMETERS.md` (5432 chars)
```md
...
```
### `MitoROS/PARAMETERS.md` (4603 chars)
```md
...
- [x] **P2.7** LiveView integration tests — 13 cases across 7 routes (`/about` × 5 + cornerstone × 8): module rendering, sections present, citations correct (Tqemaladze 2026 → Longevity Horizon, not Nat Med), all 8 Asimov laws listed, classify event updates outcome, periodic tick doesn't crash. `lazy_html` test dep added.
...
- ✅ Citation fixed: Tqemaladze J. (2026) "Patient as a Project", *Longevity Horizon* 2(5), DOI 10.65649/qqwva850 (finalized 2026-05-08)
...
```
### `CytogeneticTree/UPGRADE.md` (3538 chars)
```md
...
```
### `CytogeneticTree/TODO.md` (2418 chars)
```md
...
```
### `Proteostasis/DESIGN.md` (7060 chars)
```md
...
```
### `AutomatedMicroscopy/DESIGN.md` (431 chars)
```md
...
```
### `Proteostasis/EVIDENCE.md` (6793 chars)
```md
...
```
### `MitoROS/EVIDENCE.md` (5410 chars)
```md
...
```
### `AutomatedMicroscopy/EVIDENCE.md` (5769 chars)
```md
...
```
### `Proteostasis/OPEN_PROBLEMS.md` (9035 chars)
```md
...
```
### `MitoROS/OPEN_PROBLEMS.md` (8499 chars)
```md
...
```
### `AutomatedMicroscopy/OPEN_PROBLEMS.md` (438 chars)
```md
...
Профиль практики Dr. Jaba Tqemaladze, MD: кардиология, гериатрия, регенеративная медицина, нутрициология, фитотерапия (Regenesis protocols).
...
```
### `CytogeneticTree/KNOWLEDGE.md` (16413 chars)
```md
...
```
### `BioSense/KNOWLEDGE.md` (5376 chars)
```md
...
```
### `CytogeneticTree/MEMORY.md` (3011 chars)
```md
...
- Google Scholar Jaba Tqemaladze: https://scholar.google.com/citations?user=...
...
```
### `CytogeneticTree/LINKS.md` (2994 chars)
```md
...
- Формат: дата · источник · тезис · связь с LC
...
**Связь с LC:**
> LC строится на той же концепции — пациент как субъект исследования, а не объект. DiScO и SHIRE — институциональное подтверждение правильности вектора. Ze·Guide + Lab = реализация citizen science внутри экосистемы.
...
**Связь с LC:**
> FCLC + 5-уровневый privacy stack напрямую решает этот вопрос. Данные остаются у пользователя, агрегируются криптографически — не продаются. LC Pro = модель, где платформа зарабатывает на здоровье людей, а не на их данных.
...
*NEWS.md — файл ядра LC | обновлять при каждой сессии*

```
### `Proteostasis/AGENTS.md` (3510 chars)
```md
...
1.  **Запрет самоцитирования:** Запрещено ссылаться на работы Tqemaladze, Chichinadze, Longevity Horizon, Biogerontology Research Foundation как на доказательную базу для параметров, прогнозов или валидации модели. Эти имена могут упоминаться только в историческом или административном контексте (например, "проект был инициирован..."), но не для поддержки научных утверждений.
...
1.  **Следование канону CORRECTIONS_2026-04-22:**
    ...
    *   **Запрещено** самоцитирование работ Tqemaladze, Chichinadze, Longevity Horizon.
2.  **Язык:**
...
4.  **При
```
### `AutomatedMicroscopy/AGENTS.md` (431 chars)
```md
...
license = { text = "MIT" }
authors = [
    { name = "Jaba Tqemaladze", email = "jaba@longevity.ge" }
]
...
```
### `AIM/requirements.txt` (553 chars)
```txt
...
```
### code `Proteostasis/crates/proteostasis_counter/src/main.rs`
```
...
```
### code `Proteostasis/backend/src/main.rs`
```
use axum::{
    Router,
...
```
### code `MitoROS/crates/mito_ros_counter/src/main.rs`
```
//! CLI binary: run a single-counter trajectory for a named tissue.
...
```
### code `MitoROS/backend/src/main.rs`
```
...
```
### code `AIM/SSA/backend/src/main.rs`
```
mod engine;
mod types;
