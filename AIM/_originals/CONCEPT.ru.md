...
**Роль:** Помощник лечащего врача интегративной медицины. Не AI. Не ставит диагнозы. Интегрирует знания экосистемы LC в клиническую практику.
...
Врач ведёт пациента. AIM даёт врачу **структурированный срез знаний** из всей экосистемы LC применительно к конкретному пациенту:

- Какие счётчики старения (MCAOA C#1–C#5) у пациента затронуты?
...
│                                                          │
│  ┌──────────────┐  ┌──────────────┐  ┌───────────────┐  │
│  │ MCAOA Profiler│  │ χ_Ze Engine  │  │ Counter Map   │  │
...
- Перекрёстные связи между счётчиками (Γ-матрица MCAOA)
...
|--------|---------------|----------|
| MCAOA | CONCEPT.md, THEORY.md, PARAMETERS.md | Мета-теория, уравнение L_tissue, Γ-матрица |
...
| **Профилировщик MCAOA** | `profiler/mcoa.py` | Расчёт D_i по данным пациента |
...
AIM:
  ...
  MCAOA-профиль (по доступным данным):
  ┌─────────────────────┬──────────┬──────────────────────────────┐
...
│   ├── mcoa.py                ← MCAOA D_i(n,t) калькулятор
