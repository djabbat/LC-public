...
- ⚠️ 6 off-topic PMIDs in MCAOA files — corrected 2026-07-05
...
**Значение для CDATA:** Энтропийная теория старения уже развивается (Wu 2026, Cummings 2025, Hong 2025). CDATA даёт ей **конкретный клеточный механизм:** центриоль — физический носитель энтропии, polyGlu — её мера, асимметричное наследование — способ распределения энтропии между дочерними клетками.

---

## 1. Parent Framework: MCAOA

CDATA is Counter #1 (Centriolar) in the Multi-Counter Architecture of Organismal Aging (MCAOA). See `~/Desktop/LC/MCAOA/THEORY.md` for the full axiomatic foundation.
...
- γ: coupling strength from other MCAOA counters
...
5. **Strawbridge et al. (2026) challenge.** ES cells exit pluripotency without asymmetric division. CDATA limits its scope to adult stem cells — but the boundary between "adult" and "embryonic" stem cell programs is blurry.
...
## 7. Connection to Other MCAOA Counters
