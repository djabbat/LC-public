...
## Next deliverables (pre-submission)

1. Zheleznov LoS for Unit #2 (or contingency plan)
2. OSF pre-registration draft
3. GitHub repository placeholder
4. Desktop spec files: hardware BOM, schematic, budget (already on `~/Desktop/`)
