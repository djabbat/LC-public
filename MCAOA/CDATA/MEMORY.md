...
- ⚠️ 6 PMIDs — OFF-TOPIC (реальные, но указывают на чужие статьи). Исправлены в MCAOA/THEORY.md, MCAOA/EVIDENCE.md, MCAOA/CONCEPT.md
- ✅ CDATA/THEORY.md, CDATA/EVIDENCE.md, CDATA/CONCEPT.md, PhD/EVIDENCE.md, PhD/CONCEPT.md — полностью чисты
...
**Оценки:** CDATA core 7.5/10, MCAOA refs 5/10. Создан PEER_REVIEW_v2_2026-07-05.md.
...
- MCAOA/THEORY.md — Axiom M5 расширен до M1-M9
...
**Записано в:** CDATA/THEORY.md §2.5, CDATA/CONCEPT.md, MCAOA/THEORY.md (Axiom M5), PhD/THEORY.md
...
**Решение:** Проанализированы 3 ключевые статьи 2026 года. Найдены 30+ релевантных references. Обновлены EVIDENCE.md, CONCEPT.md, STATE.md, THEORY.md в PhD, MCAOA и CDATA.
...
## 2026-07-05 — CDATA/CONCEPT.md restoration
