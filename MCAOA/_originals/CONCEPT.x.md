...
Два draft-манускрипта расширяют MCAOA v1.0 без модификации Аксиом M1–M4. Полная формализация — в THEORY.md §4.1–4.4 и EVIDENCE.md §4.1–4.4.
