...
* **[THEORY.md]():** Полное формальное изложение аксиом, уравнений и предсказаний MCAOA.
* **[EVIDENCE.md]():** Проверенные литературные источники (PMID/DOI), внутренние данные и опровергающие свидетельства, поддерживающие или оспаривающие MCAOA.
* **[OPEN_PROBLEMS.md]():** Неразрешённые научные проблемы, приоритеты и конкретные фальсифицируемые тесты для MCAOA.
...
* **[AGENTS.md]():** Инструкции и жёсткие правила для LLM-агентов, работающих с кодом и документацией MCAOA.
