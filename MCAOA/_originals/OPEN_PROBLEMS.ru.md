...
4. **🔀 Tissue-dependent:** требует tissue-specific weighting `w_pi(tissue)` — extends MCAOA scope.
...
**Приоритет:** **Высокий** (P1). Блокирует валидное использование DNAmAge как surrogate endpoint в MCAOA-driven trials.
...
**Возможные исходы:**
1. **✅ ΔD_shadow ≈ 0 при ΔDNAmAge < 0:** подтверждает damage shadow как epigenetically-independent counter group; mandates parallel functional + structural endpoints в MCAOA trials.
