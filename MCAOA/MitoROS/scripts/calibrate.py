#!/usr/bin/env python3
"""Calibrate MitoROS counter parameters from literature anchor points.

Anchors (t_years, n_divisions, expected D_i) from:
  Sun/Youle/Finkel 2016 PMID 26942670; Ross 2013 PMID 23965628
"""
...
def main():
    ...
    calibrated = dict(
        ...
        source_pmids = 'Sun/Youle/Finkel 2016 PMID 26942670; Ross 2013 PMID 23965628',
