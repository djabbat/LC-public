defmodule McoaWebWeb.DashboardLive do
  ...
  def handle_event("run", %{"tissue" => tissue, "divisions" => n}, socket) do
    ...
    case mcaoa_simulate(tissue, n_int) do
      {:ok, records} ->
        {:noreply,
         socket
  ...
  def render(assigns) do
    ...
    <div class="p-6 max-w-5xl mx-auto">
      <h1 class="text-2xl font-bold mb-4">MCAOA — Multi-Counter Dashboard</h1>
      ...
      <form phx-submit="run" class="flex gap-4 mb-6">
        ...
        <button type="submit" class="px-4 py-1 bg-blue-600 text-white rounded">Run MCAOA</button>
      </form>
  ...
  defp mcaoa_simulate(tissue, divisions) do
