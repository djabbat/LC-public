# Ультра-строгая рецензия: теоретическое ядро экосистемы CommonHealth (Top + MCAOA + Ze)

**Дата:** 2026-04-26
**Целевые журналы:** *Nature*, *Cell*, *Science*, *eLife*, *Lancet*, *PNAS*, *Nature Aging*, *Nature Medicine*, *Phys. Rev. X*, *JHEP* (IF 18+)
**Рецензируемые файлы:**
- `/home/oem/Desktop/LC/CONCEPT.md` (v5.1, 2026-04-23)
- `/home/oem/Desktop/LC/MCAOA/{CONCEPT,EVIDENCE,THEORY,PARAMETERS,OPEN_PROBLEMS}.md` (v1.0, 2026-04-21/22)
- `/home/oem/Desktop/LC/Ze/{CONCEPT,EVIDENCE,THEORY,STATE}.md` (v2.2, 2026-04-23/25)
...
|---|------------------|------------------|------------------------------|--------|
| 1 | MCAOA/EVIDENCE.md | PMID 29227991 — Hernández-Segura *Curr Biol* 2017 | Sonney et al. *MitoTIP*, *PLoS Comp Biol* 2017 | ❌ FABRICATED |
| 2 | MCAOA/EVIDENCE.md | PMID 29643502 — Schaum *Nature* 2020 | Goriki et al. *NOTCH bladder cancer*, *Nat Rev Urol* 2018 | ❌ FABRICATED |
| 3 | MCAOA/EVIDENCE.md | PMID 16909132 — Balaban *Cell* 2005 | Phernambucq et al. *NSCLC trial*, *Br J Cancer* 2006 | ❌ FABRICATED |
| 4 | MCAOA/EVIDENCE.md | PMID 30174316 — Mathieson *Nature* 2018 | Wu et al. *striatal neurons hESC*, *Stem Cell Reports* 2018 | ❌ FABRICATED |
| 5 | MCAOA/EVIDENCE.md | PMID 33268865 — Enge *Cell* 2017 | Lu et al. *epigenetic reprogramming vision*, *Nature* 2020 | ❌ FABRICATED |
| 6 | MCAOA/EVIDENCE.md / PARAMETERS.md | PMID 12612578 — Parrinello *Nat Cell Biol* 2003 | Fontenot et al. *Foxp3 Treg*, *Nat Immunol* 2003 | ❌ FABRICATED |
| 7 | MCAOA/EVIDENCE.md / PARAMETERS.md | PMID 26833090 — Sun *Mol Cell* 2016 «Measuring In Vivo Mitophagy» | Trego et al. *XPG/BRCA*, *Mol Cell* 2016 | ❌ FABRICATED |
| 8 | MCAOA/EVIDENCE.md | PMID 31844045 — Janke & Magiera *Nat Rev Mol Cell Biol* 2020 | Park et al. *ATAD5/RAD51*, *Nat Commun* 2019 | ❌ FABRICATED |
| 9 | MCAOA/PARAMETERS.md | PMID 2038241 — α теломерного укорочения | Ratib & Huang *Desktop image analysis*, *MD Comput* 1991 | ❌ FABRICATED |
...
| 11 | MCAOA/EVIDENCE.md | DOI 10.7554/eLife.73420 — DunedinPACE | Belsky et al. *eLife* 2022, PMID 35029144 | ✅ VERIFIED |
...
|-----------|---------|-----------|
| **MCAOA** | ❌ **REJECT** (с возможностью реабилитации после полной перепроверки референсов) | 9/9 PMID фальсифицированы; пост-фактумное «To be calibrated» по 80% параметров; Аксиома M3 (априорное взвешивание) сейчас пустая — `w_i(tissue)` всегда «Placeholder» |
...
- (CO-MCAOA-1) **Аксиома M3 не обеспечена практикой.** В PARAMETERS.md все `w_i(tissue)` помечены статусом **Placeholder**, при этом MCAOA/CONCEPT.md заявляет, что они «predicted BEFORE fitting». Это противоречие — текущая версия MCAOA фактически не может быть запущена без post-hoc подгонки, что нарушает декларируемую M3.
- (CO-MCAOA-2) **Counter #1 (CDATA centriolar) — CONTESTED, а не canonical.** В §4 «ordering rationale» CP размещён первым как «unifying structural counting device», но в MCAOA/EVIDENCE.md §3.2 явно записан собственный «Парадокс ABL-2»: данные показывают, что CP может быть downstream- или параллельным маркером эпигенетического дрейфа, а не его драйвером. Внутри проекта одновременно живут «#1 canonical» и «может оказаться downstream» — несовместимо для submission-grade документа.
...
- (CO-Top-1) **«Никакой новой науки на верхнем уровне».** Это правильное заявление, но в CONCEPT.md одновременно вводятся: 4-факторная модель здоровья (новое понятие, не из MCAOA), Ze·Profile с биовозрастом, Ze·Guide с DeepSeek (новый AI-стек). Текст противоречит сам себе: либо social layer, либо новый научный конструкт. Нужен явный размежевание.

### 3.3. Missing counter-evidence (negative literature)

- (MCE-1) **MCAOA не упоминает критику hallmarks-фреймворка** (Gems & de Magalhães *Ageing Res Rev* 2021 — критика hallmarks как «catalogue, not theory»; Cohen *Nature* 2018 — против single-counter aging). MCAOA позиционирует себя как «универсальный фреймворк» без обсуждения, чем он лучше hallmarks 2.0.
- (MCE-2) **MCAOA не сравнивает себя с Klemera-Doubal Method (KDM, *Mech Ageing Dev* 2006)**, который ВЕК назад уже формализовал biological age как взвешенную сумму биомаркеров. Отсутствие KDM в discussion — серьёзный пробел в literature awareness.
...
- (MG-1) **MCAOA Test 1 ($1.5M, 6 тканей × 4 счётчика × 4 timepoint × N=85)** заявлен с FDR-correction, но без: (a) protocol pre-registration, (b) power analysis для конкретного эффект-сайза, (c) обоснования N=85 (где это число?). Приёмная комиссия EIC Pathfinder это срежет немедленно.
- (MG-2) **«LOO-CV MSE = -0.093»** в MCAOA/EVIDENCE §2.2 — отрицательный MSE математически невозможен. Комментарий «отрицательное значение указывает на потенциальную проблему» подтверждает: это либо bug, либо не-MSE-метрика (возможно, R²<0 для baseline). Цифра в submission-grade документе с пометкой «требуется повторный анализ» — automatic desk-reject.
...
|---|------|----------------|------------------|-----------|
| 1 | MCAOA/EVIDENCE.md строка 10 | PMID 29227991 | заменить на **28844647** + проверить, что это действительно Hernandez-Segura *Curr Biol* 2017 | P0 |
| 2 | MCAOA/EVIDENCE.md строка 11 | PMID 29643502 | заменить на **32669715** (Schaum *Nature* 2020) | P0 |
| 3 | MCAOA/EVIDENCE.md строка 12 | PMID 16909132 | заменить на **15734681** (Balaban *Cell* 2005) | P0 |
| 4 | MCAOA/EVIDENCE.md строка 17 | PMID 30174316 + журнал «Nature» | заменить на **29449567**, журнал — *Nat Commun* (НЕ *Nature*) | P0 |
| 5 | MCAOA/EVIDENCE.md строка 18 | PMID 33268865 | заменить на **28965763** (Enge *Cell* 2017) | P0 |
| 6 | MCAOA/EVIDENCE.md строка 23 + PARAMETERS.md строка 85 | PMID 12612578 | заменить на **12855956** (Parrinello *Nat Cell Biol* 2003) | P0 |
| 7 | MCAOA/EVIDENCE.md строка 24 + PARAMETERS.md строка 87 | PMID 26833090 + ссылка на «Sun *Mol Cell* 2016 *Measuring In Vivo Mitophagy*» | удалить — такой работы не существует. Если имеется в виду Sun et al. *Nat Protoc* 2017 (PMID 28132843), указать корректно; если другая Sun 2016 о NAD+/sirtuin/aging — найти и привести её | P0 |
| 8 | MCAOA/EVIDENCE.md строка 25 | PMID 31844045 | заменить на **32107477** (Janke & Magiera *Nat Rev Mol Cell Biol* 2020) | P0 |
| 9 | MCAOA/PARAMETERS.md строка 39 | PMID 2038241 для α_Tel | удалить — это статья 1991 г. о desktop image analysis. Заменить на верифицированную теломерную работу (например, Allsopp et al. *PNAS* 1992, PMID 1631178; Harley et al. *Nature* 1990, PMID 2342578) | P0 |
...
| 11 | MCAOA/EVIDENCE.md §2.2 | LOO-CV MSE = -0.093 | удалить или заменить на корректную метрику (R², MAE) с положительным значением; при отрицательном R² (хуже среднего) — явно указать «модель хуже baseline» | P0 |
| 12 | MCAOA/PARAMETERS.md «Таблица весов тканей w_i» | все значения помечены Placeholder | заменить на априорный прогноз с источниками или удалить таблицу до получения данных. Текущее состояние нарушает Аксиому M3 | P0 |
| 13 | MCAOA/CONCEPT.md «Counter #1 ordering rationale» | CP заявлен как «unifying structural counting device» | пересформулировать с явным признанием парадокса ABL-2 и понизить статус до «hypothesis to be tested by Test 2A» | P1 |
...
1. **(R1) Полная reverse-verification ВСЕХ 24+ цитирований** в MCAOA/EVIDENCE, PARAMETERS, CONCEPT, OPEN_PROBLEMS и Ze/EVIDENCE через PubMed/Crossref. Каждый PMID — с датой проверки. Любой не-резолвящийся PMID — удалить.
...
3. **(R3) MCAOA Аксиома M3 — реальное обеспечение.** До submission заполнить таблицу w_i(tissue) реальными априорными прогнозами на основе RNA-seq (Tabula Muris/Sapiens), exposing метод предсказания (например, ridge regression на gene expression panel) и pre-register protocol на OSF.
...
**Top-level CommonHealth.** Это **не научный артикль**, а инженерный документ + продуктовая концепция. Для журнала вроде *npj Digital Medicine* / *Lancet Digital Health* потребуется либо (a) clinical study protocol с pre-registered endpoints, либо (b) systems-engineering paper с performance benchmarks. Архитектура «thin social layer over MCAOA» — STRONGLY SUPPORTED как design pattern; конкретная реализация — требует engineering metrics, которых пока нет. **Major Revision** при условии R7.

**Совокупный вердикт.** Текущее состояние теоретического ядра CommonHealth (Top + MCAOA + Ze) **не соответствует submission-grade для журналов IF 18+** в первую очередь из-за **systematic citation fabrication** в MCAOA — это ground-zero issue, перекрывающий все остальные. До полной переверификации всех ссылок и audit log (R1, R2) вся экосистема находится в категории **REJECT WITHOUT EXTERNAL REVIEW**. После выполнения R1–R10 MCAOA реалистично достигает Nature Aging tier; Ze требует переориентации на arXiv/Synthese; Top-level — npj Digital Medicine engineering paper.
...
**Файл сохранён:** `/home/oem/Desktop/LC/_audits/PEER_REVIEW_v2_TopMCOAZe_2026-04-26.md`
