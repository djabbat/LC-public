...
2.  **Следование CORRECTIONS_2026-04-22:** Все утверждения должны быть сверены с каноном CORRECTIONS. В частности:
    ...
    *   **χ_Ze:** Не упоминать χ_Ze как валидированный клинический биомаркер. Разрешено упоминание только как теоретического конструкта в абстрактной физической теории (Ze Vector Theory).
