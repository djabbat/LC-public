...
// from MCARA L_tissue. Retained here only as transitional research composite
// (always accompanied by HEALTH_SCORE_DISCLAIMER). Planned replacement: L_tissue
// per tissue type from MCARA calibration. See LC/TODO.md architectural item.
...
pub struct HealthFactorSummary {
    ...
    /// tissue-specific L_tissue from MCARA. None if fewer than 2 factors have data.
