...
| `α_Tel` | Интенсивность укорочения за деление | 0.02 – 0.04 (соответствует ~50-100 п.н. за деление) | безразмерн. на (`n / n_Tel*`) | Литература: среднее укорочение теломер за деление | **Fixed (Measured)** [PMID: 2038241] |
...
|-------------------------|----|----------|---------|----------|------|
| **CP** | – | 0 | 0 | 0 | 0 |
| **Telomere** | 0 | – | **To be measured** (PMID:12612578) | 0 | 0 |
| **MitoROS** | 0 | 0 | – | 0 | 0 |
| **EpiDrift** | 0 | 0 | **To be measured** (PMID:26833090) | – | 0 |
| **Prot** | 0 | 0 | 0 | 0 | – |
