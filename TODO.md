<!-- AUTO-TRANSLATED via DeepSeek 2026-05-13. Source language: mixed. Original preserved at TODO.x.md. -->
...
- [x] ~~2026-04-28~~ Joao Gonzalez (отменён — EIC вместо Open) meeting — coordinator confirmation (today, gating)
- [x] ~~2026-05-01~~ Tsomaia Q1-Q6 (отложен) freeze (E0 Phase 1 ordering)
- [x] ~~2026-05-12~~ EIC Pathfinder Open (отменён — фокус на EIC Challenges 28 Oct) deadline — NOT participating (deferred)
...
- [ ] N≥2000 pre-registered cohort acquisition (UK Biobank wearable subset OR All-of-Us OR Activated pilot)
...
- Hevolution NIA — requires Independent Asst/Assoc Prof appointment (Tqemaladze does not qualify)
