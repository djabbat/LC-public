...
*   **Centriole Inheritance as Lineage Tracer:** The foundational hypothesis that non-random centriole inheritance could imprint lineage information is explored in work on asymmetric stem cell divisions [PMID-PENDING-VERIFY]. Recent single-cell studies in murine epithelium provide direct evidence of non-random centriole age distribution correlating with fate [PMID-PENDING-VERIFY].
*   **Survival Analysis in Cell Biology:** The application of Kaplan-Meier and Cox proportional hazards models to cellular events (e.g., pluripotency exit, apoptosis) is well-established [PMID-PENDING-VERIFY]. Its application to a structural organelle's retention as a fate marker is novel.
