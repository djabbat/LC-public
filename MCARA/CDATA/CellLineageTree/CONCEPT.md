...
## §2 Theoretical framework (CDATA Counter #1 in MCARA)
...
To address potential confirmation bias and situate the centriolar damage model within the broader aging literature, we compare CDATA with five leading mechanistic theories, including both those explicitly in MCARA and additional widely discussed mechanisms.
