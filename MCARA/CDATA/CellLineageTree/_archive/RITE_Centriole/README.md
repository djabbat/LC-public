...
- **OSF ID:** `osf.io/TBD (pre-registration planned before data collection; embargo until 2025-12-01)` (to be registered before data collection)
- **Planned registration date:** 2025-12-01
- **Repository:** [github.com/CytogeneticTree/RITE_Centriole](https://github.com/CytogeneticTree/RITE_Centriole) (code will be made public upon acceptance)
- **Data deposit:** All raw imaging data and analysis scripts will be deposited in Zenodo upon publication.
