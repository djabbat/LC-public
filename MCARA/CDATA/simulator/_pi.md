...
## Связи
- **LC/MCARA/CDATA** — научная теория и концепт
- **LC/MCARA/CDATA/Aubrey** — применение модели в грантовых заявках
