...
Mitochondrial ROS and mtDNA Damage as Counter #3 in the Multi-Counter Architecture of Replicative Aging.

## Overview

This backend implements the MitoROS (Counter #3) subproject for LC. It provides REST API endpoints for managing and computing mitochondrial damage accumulation according to the MCARA framework.
...
- **Tissue Registry**: Manage biological tissues with MCARA weights
...
- `weight_w3`: MCARA weight for Counter #3
