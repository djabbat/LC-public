//! Tissue-specific parameter panel for MCAOA Counter #3.
//!
...
impl Tissue {
    ...
    /// a-priori weight w_3(tissue) for this counter.
    /// Sum across the 5 MCAOA counters for any one tissue should be ~1.0.
    pub fn weight(self) -> f64 {
        match self {
            Tissue::HSC             => 0.2,
            Tissue::Fibroblast      => 0.2,
            Tissue::Neuron          => 0.45,
            Tissue::Cardiomyocyte   => 0.6,
            Tissue::Hepatocyte      => 0.4,
