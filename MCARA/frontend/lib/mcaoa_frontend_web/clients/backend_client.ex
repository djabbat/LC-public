defmodule MCAOAFrontend.BackendClient do
  use Tesla
  require Logger

  @timeout Application.get_env(:mcaoa_frontend, :api_timeout)
  @backend_url Application.get_env(:mcaoa_frontend, :backend_url)
  ...
  def measure_health do
    ...
    :telemetry.execute([:mcaoa_frontend, :backend_client, :health_check], %{duration: duration}, %{status: status})
  end
