defmodule MCAOAFrontendWeb.DashboardLive do
  use MCAOAFrontendWeb, :live_view
  alias MCAOAFrontend.BackendClient
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     socket
     |> assign(page_title: "MCAOA Dashboard")
  ...
  def handle_params(params, _uri, socket) do
    ...
    {:noreply,
     ...
     |> assign(page_title: if(current_page == :registry, do: "Counter Registry", else: "MCAOA Dashboard"))}
  end
  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      <.alert :if={@backend_status == :unhealthy} type="warning">
        Backend API unavailable at <%= Application.get_env(:mcaoa_frontend, :backend_url) %>.
