# MCARA — Multi-Counter Architecture of Organismal Aging

> ⚠️ **См. [../CORRECTIONS_2026-04-22.md]()** — некоторые утверждения могут быть отозваны. Каноны обновлены 2026-04-22.


**Project:** MCARA (Multi-Counter Architecture of Organismal Aging)
...
All Γ entries must be measured, not fitted. ~~MCARA Test 2~~ [отозвано — see CORRECTIONS §1.3] (§6.2 Perspective) is the canonical measurement protocol.
...
| Ontogenesis | Developmental trajectory (0–25 yr) with MCARA counter families |
| HAP | Clinical backdrop; no direct MCARA integration |
...
- MCARA is not a new set of biomarkers — it uses existing ones (Horvath, DunedinPACE, GT335, MitoSOX, telomere qFISH, 8-OHdG).
- MCARA is not a single-disease theory — it is a framework that any specific disease/tissue can be reduced to.
- MCARA does not assume "no repair" — repair appears as a negative contribution to the counter's drift rate.
- MCARA does not privilege any counter a priori — weights are measured, not decreed.

---

**Version:** 1.0
**Date:** 2026-04-21
**Next revision trigger:** Nature Aging editorial decision OR completion of MCARA Test 4 simulation.


---

## Роль MCARA в EIC Pathfinder Part B v3 (Variant B, submission 2026-05-12)
...
1. Публикация MCARA specification paper (открытый стандарт)
...
Два draft-манускрипта расширяют MCARA v1.0 без модификации Аксиом M1–M4. Полная формализация — в THEORY.md §4.1–4.4 и EVIDENCE.md §4.1–4.4.
