# Эмпирические свидетельства для MCARA
...
*Эта секция напрямую связана с [OPEN_PROBLEMS.md]().*
 ...
 * **Следствие:** Текущие реализации MCARA вынуждены использовать упрощённые эвристики или placeholder-значения для `w_i`. Это ослабляет проверяемость Аксиомы M3.
 ...
 * **Следствие:** Исключает возможность простого использования χ_Ze в качестве «шестого», интегрального счётчика синхронизации в текущей версии MCARA. χ_Ze остаётся теоретическим конструктом.
