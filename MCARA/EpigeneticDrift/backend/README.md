...
REST API backend for the Epigenetic Drift Counter (#4) in the Multi-Counter Architecture of Organismal Aging (MCARA).
...
2. No health score aggregation (removed from MCARA)
