...
MCARA Counter #2: Telomere Shortening Counter backend service.

## Overview

This service implements the Telomere Shortening Counter as defined in the Multi-Counter Architecture of Organismal Aging (MCARA). It provides REST APIs for storing and retrieving telomere measurements, managing kinetic equation parameters, and computing tissue-specific aging loads.
...
- **Counter Registry**: MCARA-compliant counter metadata endpoint
...
- `GET /api/v1/counters` - List all MCARA counters (only Telomere #2)
...
The telomere shortening counter follows the MCARA kinetic equation:
...
This service implements Counter #2 according to the MCARA specification:
