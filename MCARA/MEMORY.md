...
- **Ключевые исправления:**
  1. **Планарии:** Azimzadeh 2012 (PMID 22223737) — необласты ИМЕЮТ центриоли. Потеряны центросомы (PCM), не центриоли. Все документы исправлены.
  2. **DID-РНК:** понижена до спекулятивной модели. Удалена из основной теории CEDAR. Сохранена в `DID_Centricle_Dve_Linii.md`.
  3. **C. elegans:** механизм элиминации признан неизвестным. Добавлено явное указание во все файлы.
  4. **Предсказание:** «≥2×» → «1.5–10×» с обоснованием диапазона.
  5. **Эксперимент:** добавлена группа Centrinone + DUX4/TPRX1.
- **Верифицированы PMID:** FERMT3 (42343301) ✅, ALMS1 (42380124) ✅, Azimzadeh (22223737) ✅
- **Файлы:** CONCEPT.md, THEORY.md, STATE.md обновлены. EVIDENCE.md — в очереди.
- **Полный аудит:** `audits/DEEP_ANALYSIS_MCARA_2026-07-17.md`
