...
- [ ] 🔍 Check: does Chk1 decrease with age in HSC? (PubMed search)
- [ ] 📎 Add Zachos to the list of CIRCBIO-07 partners
- [ ] 📄 Reference PMID 41844775 + 42229233 in EIC Pathfinder Part B
<!-- /lang:ru -->

<!-- lang:ru -->
## Old - [ ] **Concept note for reverse experiment** — deadline 15.04 - [ ] **BOLD PILOT (Aubrey)** — deadline 15.04 - [ ] **Iron stain pilot** — deadline 15.04 - [ ] **aubrey-core** — deadline 15.04 - [ ] **FreeCAD model** — deadline 15.04 - [ ] **CellPose** — deadline 15.04 - [ ] **CEDAR/CONCEPT.md** — deadline 15.04 - [ ] **Part B of the application** — deadline 15.04 - [x] 🟢 **Call Shutzaiser — Wageningen completed** — 2025-04-10 - [x] 🟢 **Call Gönczy — 15 min** — 2025-04-10 - [x] 🟢 **Call Čajánek — 30 min** — 2025-04-10 - [x] 🟢 **Call Trifunovic — 30 min** — 2025-04-10 - [x] 🟢 **Letter from Trifunovic** — 2025-04-10
<!-- /lang:ru -->
