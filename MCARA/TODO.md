...
## 🔴 P0 — EIC Pathfinder (дедлайн 28 окт 2026)
...
## 🔴 P0 — BOLD PILOT (Aubrey)

- [x] Письмо Jacquemet отправлено
- [x] Письмо F ($1,600 софинансирование)
...
- [ ] NLnet — ждать решения (12-15 нед)
- [ ] Open Tech Fund — подготовить заявку
- [ ] Mozilla Foundation Awards — подготовить заявку
- [ ] Ждать дошлифовки ТЗ от Алексея
...
- [ ] Обновить CEDAR/CONCEPT.md под v4.4
- [ ] Обновить _pi.md всех подпроектов
- [ ] Конвертировать MCARA_Concept_Note в PDF для рассылки

## 🟢 P2 — Параллельно

- [ ] MCARA статья в Biogerontology — отслеживать peer review
- [ ] ARGUS-LP Bold Pilot — отслеживать
- [ ] Follow-up Macip (встреча 12 июня)
- [ ] Встреча с Denis Reiss (EU Delegation) — подтвердить дату

## 🟢 P2 — Публикации (фоновые)

- [ ] Interference → найти журнал
- [ ] Macrobiome/Microbiome → BBS (TAP)
- [ ] Plant Cognition → журнал
- [ ] Activatus SR → ждать решения
...
- [x] STATE.md v4.4
- [x] MEMORY.md v4.4
- [x] Concept Note на Desktop
- [x] ARGUS-LP, Aubrey, CEDAR (Marketing) → MCARA/
- [x] KorkotiLine, BACCHUS → Marketing/_archive/
- [x] Trifunovic вошла в консорциум
- [x] Звонок Шутзайзер — Wageningen вышел
- [x] Ответ Вагнеру отправлен
