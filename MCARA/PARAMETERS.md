...
### Тотипотентность vs Плюрипотентность (2026-07-12)
| Параметр | OSKM → Плюрипотентность | Centriole elim + OSKM | Centriole elim + Toti factors |
|----------|:---:|:---:|:---:|
| Эффективность iPSC | 0.1–1% (контроль) | ≥2× (предсказание) | TBD |
| Трофобласт (CDX2+) | ❌ | 🟡 возможно | ✅ предсказание |
| MERVL активация | ❌ | 🟡 частично? | ✅ предсказание |
| ZSCAN4 ↑ | ❌ | TBD | ✅ предсказание |
| SA-DNAm сброс | Частичный | TBD (Вагнер) | TBD |
| Статус центриолей | Сохранены | Элиминированы | Элиминированы |
