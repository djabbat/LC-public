...
> **Review by D. Meyer (CECAD, 13 Aug 2026) — accepted:** SAS-6/Cartwheel is not persistent in mature structures (Huang 2025 PMID 39614048; Li 2017 PMID 28743734; Serwas 2017 PMID 28411189) → targets of the persistent structure: triplet wall, inner scaffold (Le Guennec 2020 PMID 32110738), appendage rings. Direct first test: pulse-labeling mother vs daughter (U-ExM, M1–M5) in a single cell background. Grant track: VW Pioneering Research (27 Aug 2026, lead — CECAD/Meyer, GLA — partner).
