...
| 5 | **Proteostatic** | Protein aggregation, chaperone/autophagy decline | `LC/MCARA/Proteostasis/` |
...
MCARA Phase III Concept v3.2 — **Conditionally approved** for PhD defense (77.75/100) by the thesis committee (Prof. Torres Ruiz, UCLM).
...
@software{mcoa_simulator,
  ...
  url = {https://github.com/djabbat/LC/tree/mcaoa-v3.2/MCARA}
}
```
