...
This is the backend service for the MCARA (Multi-Counter Architecture of Organismal Aging) subproject of LC. It provides a REST API for managing the five canonical aging counters, tissues, subjects, damage measurements, and computing tissue loads according to the MCARA framework.
