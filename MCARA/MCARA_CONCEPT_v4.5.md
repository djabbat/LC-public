...
Центриоль — **условный носитель энтропии (conditional entropy carrier):** polyE накапливается, когда центриоль работает как центросома (стресс-чувствительное состояние), и прекращает накопление, когда центриоль темплатирует цилию. Накопление зависит от функционального состояния и стресс-среды, а не только от хронологического времени.
...
|:--:|------|----------|:------:|---------|
| **C1** | Центриолярный | polyE накопление + CAASM → лимит делений. Stress integrator. | 🏃 **Фаворит** — без защиты | GLA |
