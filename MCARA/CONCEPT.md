...
**Date:** 2026-07-19
**Version:** v5.8 — programmed templated geometry (2026-08-11) — Centriculum (Maheshwari 2023/2026) + Spermatogenesis (Ishida & Shibuya 2026)
...
>
> **Mechanism (per CEDAR v1.8):** (1) **geometry, not abstract entropy** — semi-conservative duplication templates mother→daughter deformation; **the geometry change is most likely PROGRAMMED — a deterministic part of the differentiation mechanism itself** (the substrate of the differentiation ratchet), not passive damage; (2) **chemical pathway [H]** — possible differentiation-inducer molecules produced in first blastomeres; (3) **age-driven entropy accumulation** → functional decline: reduced division frequency (centrosome function) + impaired niche-signal responses (cilium function).
>
...
>
> **Aging mechanism (per CEDAR v1.7, corrected):** the organism ages **because the oldest centrioles (most errors) accumulate in stem cells** → division tempo falls + niche-signal perception falls → **tissue self-repair declines while self-destruction rises** (imbalance repair↓/destruction↑). The germline escapes by releasing the ratchet (elimination + de novo); lineages that relaxed the ratchet (planarians — centrosome loss, Azimzadeh 2012; Hydra) show attenuated aging (correlative, caveated).
>
