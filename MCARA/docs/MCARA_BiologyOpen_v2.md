...
The centriole is a small cylinder of microtubules that every dividing cell inherits from its mother. It has been studied for over a century as a spindle-organizer — the structure that ensures chromosomes separate cleanly at mitosis. But a spindle-organizer does not explain why 551 of 558 cells in a C. elegans embryo eliminate theirs upon differentiation [4], or why planarians have evolutionarily abandoned centrioles entirely from proliferating cells — including neoblasts and embryonic cells — assembling them only de novo during terminal differentiation [5], or why the mother centriole is not inherited randomly but handed preferentially to one daughter at division [6,7].
...
PolyE is not a simple clock. It is a structural index of the centriole-to-cilium ratio — higher when the centriole has a long history of centrosomal dominance, lower when the cilium has been maintained. PolyE is also a compensatory response to structural entropy: as the centriole accumulates damage, TTLL enzymes add polyE to stabilise its microtubules. The balance between TTLL-mediated glutamylation and CCP-mediated deglutamylation reflects the centriole's ongoing struggle against thermodynamic decay.

In young cells with a plastic phenotype, the cilium is long, the centriole is short, polyE is low, and Wnt/Hedgehog signalling is active. In old cells with a committed phenotype, the cilium is short or absent, the centriole is long, polyE is high, and Wnt/Hedgehog signalling is suppressed. The centriole-to-cilium ratio, measured by polyE accumulation, increases monotonically with passage number — a prediction testable by expansion microscopy (U-ExM) with GT335 anti-polyE staining.
...
**C. elegans: Elimination Locks the Post-Mitotic State**
...
**Drosophila: Forced Retention Breaks Totipotency**
...
**Planarians: Centrosome and Centriole Loss — Maximal Plasticity Without Centrioles**

The planarian *Schmidtea mediterranea* regenerates any body part from a population of pluripotent stem cells called neoblasts. Azimzadeh and colleagues made a striking discovery: planarians have evolutionarily lost both centrosomes (PCM) and centrioles from all proliferating cells [5]. Immunofluorescence for the centriolar marker SMED-CEP135 and transmission electron microscopy both confirmed that centrioles are **absent** during neoblast mitosis and from spindle poles. The same result was obtained in *S. mediterranea* embryos — dividing embryonic cells also lack centrioles [5, Fig. S4]. Planarians do not require centrioles at any stage of development.

This is a unique strategy among animals. Planarians assemble centrioles only de novo in two contexts: (a) terminal differentiation into multiciliated cells of the epidermis and pharynx, and (b) spermiogenesis, where centrioles are built de novo for flagellar assembly [14,15]. In all other contexts — stem cells, embryonic cells, non-ciliated differentiated cells — centrioles are absent.

When a neoblast commits to mucociliary differentiation, it assembles hundreds of centrioles de novo via the canonical Plk4/Sas6/Cep152 pathway [14]. The cells are initially centriole-free; centrioles do not pre-exist in neoblasts. De novo centriole appearance — not amplification of pre-existing centrioles — marks the transition from stemness to terminal differentiation. The pattern is convergent with C. elegans (programmed elimination upon differentiation) and Drosophila (centriole elimination in oogenesis), but the principle is more radical: in planarians, the most plastic cells in the animal kingdom are permanently centriole-free. The absence of centrioles — and of the centrosome-organised signalling complexes they anchor — may be a prerequisite for the remarkable plasticity of neoblasts.

**Mammals: The Mother Centriole Chooses Fates**
...
Yamashita and colleagues first showed this in Drosophila germline stem cells: the mother centrosome stays with the stem cell [6]. Wang and colleagues extended the finding to the mammalian neocortex, showing that the older mother centriole is retained in radial glia progenitors while the newer mother centriole segregates to differentiating cells; removal of ninein disrupted this asymmetry and prematurely depleted progenitors [15]. The pattern is not limited to neural progenitors. Izumi and Kaneko demonstrated asymmetric centrosome inheritance in human neuroblastoma cells, with the older mother centriole migrating to one daughter and the younger to the other [16]. Barandun and colleagues found the same principle in mammalian CD8+ T-cells: the daughter that inherits the mother centrosome becomes an effector cell; the other becomes a memory cell [7]. Zhao and colleagues showed that in zebrafish radial glia, the mother centrosome coordinates polarized endosome trafficking to determine whether a division produces two progenitors or a progenitor and a neuron [17].

In parallel, asymmetric segregation of epigenetic information during germline stem cell division has been demonstrated for histones in Drosophila [18] and for the centromeric histone variant CENP-A, whose age-dependent loss in germline stem cells — regulated by CENP-C — provides a direct molecular link between asymmetric inheritance and epigenetic age [19]. The 'mitotic drive' model provides a framework for how epigenetically distinct sister chromatids are differentially segregated [20]. While recent work using photoconvertible reporters has questioned whether histones H3.1 and H3.3A are asymmetrically segregated in all stem cell contexts [21], centrosome asymmetry is independently validated across multiple species using diverse methodologies.
...
**Human Cells: A Centriole Protein That Triggers Senescence**

In 2026, Raheja and colleagues reported that the microprotein miP-FERMT3 localises to centriole subdistal appendages — the same structures that anchor ninein. It triggers p53-independent senescence by promoting proteasomal degradation of p21 [22]. FERMT3 expression increases with age in both mouse and human endothelium. Separately, Ozaki and colleagues showed that the intrinsically disordered protein ALMS1 seeds centriole cartwheel assembly and may confer a form of structural memory on the organelle [23].

These are the first molecular chains traced from specific centriole substructures to specific cell-fate outcomes. They run through the same appendages that control asymmetric centrosome inheritance. A third protein, ATF5, forms a physical bridge between the pericentriolar material and the proximal end of the mother centriole, its localisation tied to centriole age and polyE status [24]. The ciliary membrane attached to the mother centriole is itself asymmetrically inherited during neural stem cell division, and the daughter that inherits it re-establishes a signalling-competent primary cilium earlier than its sibling [25] — a direct demonstration that centrosome-associated structures carry information that biases daughter cell behaviour. A centrosome-centric review of asymmetric stem cell division summarises the current state of the field [26]. Together, ATF5, FERMT3, ALMS1, and asymmetrically inherited ciliary membrane are candidate components of a Centrosome-Associated Memory Complex (CAMC) — a hypothetical assembly that translates centriole history into cell-fate decisions.
...
|:---:|---|---|---|
| C1 | Centriole | Divisions survived; centriole/cilium ratio via polyE | Unknown |
| C2 | Telomere | Telomere length, DDR | Yes (hTERT) |
| C3 | Mitochondrion | mtDNA mutations, ROS | Yes (2% O₂) |
| C4 | Epigenome | CpG methylation, Horvath clock | ~30–40% (partial reprogramming) |
...
The centriole is absent from the Hallmarks of Aging [27] and from the Hallmarks of Stem Cell Aging [28]. The omission matters if the centriole does function as a structural memory device — one whose accumulated history determines whether a cell can change identity.
...
Fourteen groups are required to distinguish five competing hypotheses (Table 2). Groups 1–3 test whether centriole loss affects reprogramming and whether the effect depends on p53/p38 stress. Group 4 controls for Aurora A off-target effects. Group 5 tests the nucleus-to-cilium senescence pathway (KIFC3). Group 6 tests the centriolar fate-switch protein ODF2. Group 7 tests cilium loss without centriole loss (IFT88). Group 8 tests proteostasis (MG132). Group 9 provides genetic confirmation (SAS6-KO). Groups 10–11 use laser ablation to distinguish centriole removal from CAMC removal. Group 12 tests reversibility (centrinone washout). Group 13 discriminates centriole effects from pericentriolar material effects (CEP192-KD). Group 14 tests totipotency: centriole elimination followed by DUX4 and TPRX1, with MERVL and Zscan4 as readouts.
...
Renzova and colleagues provided the closest precedent [30]. They treated human embryonic stem cells and iPSCs with centrinone, a PLK4 inhibitor. The cells lost their centrioles and, within days, their pluripotency. OCT4 and NANOG were degraded. The cells differentiated into all three germ layers.
...
[15] Rouhana L, Chong T, Newmark PA. Analysis of morphogenesis and flagellar assembly during spermatogenesis in planarian flatworms. *Methods Mol Biol* 2364:199–216 (2022). PMID: 34542855.

[16] Wang X et al. Asymmetric centrosome inheritance maintains neural progenitors in the neocortex. *Nature* 461:947–955 (2009). PMID: 19829375.
...
[19] Carty BL et al. CENP-C functions in centromere assembly, the maintenance of CENP-A asymmetry and epigenetic age in Drosophila germline stem cells. *PLoS Genet* 17:e1009247 (2021). PMID: 34014920.

[20] Ranjan R, Chen X. Mitotic drive in asymmetric epigenetic inheritance. *Biochem Soc Trans* 50:675–688 (2022). PMID: 35437581.

[21] Li A et al. Reevaluation of whether histones are asymmetrically segregated during asymmetric divisions of stem cells in Drosophila. *Proc Natl Acad Sci USA* 122:e2513015122 (2025). PMID: 41166424.

[22] Raheja R et al. A microprotein encoded by FERMT3 modulates endothelial cell protein catabolism and induces cell cycle arrest and senescence. *Nat Commun* (2026). PMID: 42343301.

[23] Ozaki K, Chang TJB, Yang WQ et al. Adaptable centriole biogenesis via the intrinsically disordered protein ALMS1. *Nat Commun* (2026). PMID: 42380124.

[24] Madarampalli B et al. ATF5 connects the pericentriolar materials to the proximal end of the mother centriole. *Cell* 162:580–592 (2015). PMID: 26213385.

[25] Paridaen JT et al. Asymmetric inheritance of centrosome-associated primary cilium membrane directs ciliogenesis after cell division. *Cell* 155:333–344 (2013). PMID: 24120134.

[26] Chen C, Yamashita YM. Centrosome-centric view of asymmetric stem cell division. *Open Biol* 11:200314 (2021). PMID: 33435817.

[27] López-Otín C et al. Hallmarks of aging: an expanding universe. *Cell* 186:243–278 (2023). PMID: 36599349.

[28] Brunet A et al. Hallmarks of stem cell aging. *Cell Stem Cell* 32:751–774 (2025). PMID: 40562035.

[29] Robichaud JH et al. Transiently formed nucleus-to-cilium microtubule arrays mediate senescence initiation in a KIFC3-dependent manner. *Nat Commun* 15:7954 (2024). PMID: 39266565.

[30] Renzova T et al. Inactivation of PLK4-STIL module prevents self-renewal and triggers p53-dependent differentiation in human pluripotent stem cells. *Stem Cell Reports* 11:959–972 (2018). PMID: 30197118.
