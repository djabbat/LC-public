...
Проект является частью более широкой экосистемы CommonHealth и следует канонам, установленным в документе **CORRECTIONS_2026-04-22**. Все утверждения, отозванные в этом документе (например, о формуле Health Score или χ_Ze как валидированном биомаркере), здесь не используются.
