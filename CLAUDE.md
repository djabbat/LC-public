...
**Правило:** LongevityCommon — thin social layer over FCLC+Ze+CDATA+BioSense+Ontogenesis. Никакой новой науки, никакой новой privacy-инфраструктуры. Новое: UX сообщества, ранжирование ленты, Ze·Guide AI.
...
**Git (монорепозиторий):**
- **Единый репозиторий:** `djabbat/LongevityCommon` (объединяет LongevityCommon + FCLC + Ze + CDATA + BioSense + Ontogenesis)
